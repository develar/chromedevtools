...
public class HighlightRectParams extends org.jetbrains.wip.protocol.WipParams {
   ...
   */
  public HighlightRectParams(long x, long y, long width, long height, org.chromium.wip.protocol.output.dom.RGBAParam colorOpt, org.chromium.wip.protocol.output.dom.RGBAParam outlineColorOpt) {
    //this.put("x", x);
    //this.put("y", y);
