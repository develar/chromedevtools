...
public class CallFunctionOnParams extends org.jetbrains.wip.protocol.WipParamsWithResponse<org.chromium.wip.protocol.input.runtime.CallFunctionOnData> {
   ...
   */
  public CallFunctionOnParams(String objectId, String functionDeclaration, java.util.List<org.chromium.wip.protocol.output.runtime.CallArgumentParam> argumentsOpt, boolean doNotPauseOnExceptionsAndMuteConsoleOpt, boolean returnByValueOpt, boolean generatePreviewOpt) {
  ...
  @Override public org.chromium.wip.protocol.input.runtime.CallFunctionOnData parseResponse(org.jetbrains.wip.protocol.WipCommandResponse.Data data, org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser) throws java.io.IOException {
