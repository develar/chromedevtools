...
public final class CallFunctionOnParams extends org.jetbrains.wip.WipRequestWithResponse<org.chromium.wip.protocol.input.runtime.CallFunctionOnData> {
   ...
   */
  public CallFunctionOnParams(String objectId, String functionDeclaration) {
   ...
   */
  public CallFunctionOnParams arguments(java.util.List<org.chromium.wip.protocol.output.runtime.CallArgumentParam> v) {
    put("arguments", v);
    return this;
  }
   ...
   */
  public CallFunctionOnParams doNotPauseOnExceptionsAndMuteConsole(boolean v) {
   ...
   */
  public CallFunctionOnParams returnByValue(boolean v) {
    put("returnByValue", v);
    return this;
  }
   ...
   */
  public CallFunctionOnParams generatePreview(boolean v) {
