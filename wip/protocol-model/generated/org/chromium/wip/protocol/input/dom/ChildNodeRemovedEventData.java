...
public interface ChildNodeRemovedEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.dom.ChildNodeRemovedEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.dom.ChildNodeRemovedEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) {
