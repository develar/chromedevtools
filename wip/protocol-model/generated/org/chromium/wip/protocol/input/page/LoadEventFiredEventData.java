...
public interface LoadEventFiredEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.page.LoadEventFiredEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.page.LoadEventFiredEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) {
