...
public interface WebSocketCreatedEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.network.WebSocketCreatedEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.network.WebSocketCreatedEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) throws java.io.IOException {
