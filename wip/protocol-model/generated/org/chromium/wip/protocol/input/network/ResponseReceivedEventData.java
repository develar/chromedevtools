...
public interface ResponseReceivedEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.network.ResponseReceivedEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.network.ResponseReceivedEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) throws java.io.IOException {
