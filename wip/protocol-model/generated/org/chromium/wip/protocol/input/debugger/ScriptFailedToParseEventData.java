...
public interface ScriptFailedToParseEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.debugger.ScriptFailedToParseEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.debugger.ScriptFailedToParseEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) throws java.io.IOException {
