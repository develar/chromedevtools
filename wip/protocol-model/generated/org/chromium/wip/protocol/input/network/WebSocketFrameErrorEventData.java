...
public interface WebSocketFrameErrorEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.network.WebSocketFrameErrorEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.network.WebSocketFrameErrorEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) throws java.io.IOException {
