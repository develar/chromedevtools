...
public interface DomContentEventFiredEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.page.DomContentEventFiredEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.page.DomContentEventFiredEventData parse(org.chromium.wip.protocol.input.ProtocolReponseReader parser, com.google.gson.stream.JsonReaderEx reader) {
