...
public interface DataReceivedEventData {
  ...
  public static final org.jetbrains.wip.protocol.WipEventType<org.chromium.wip.protocol.input.network.DataReceivedEventData> TYPE
    ...
    @Override
    public org.chromium.wip.protocol.input.network.DataReceivedEventData parse(org.chromium.wip.protocol.input.GeneratedWipProtocolReader parser, com.google.gson.stream.JsonReaderEx reader) {
