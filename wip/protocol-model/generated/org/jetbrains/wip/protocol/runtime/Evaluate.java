 ...
 */
public final class Evaluate extends org.jetbrains.wip.protocol.WipRequest implements org.jetbrains.jsonProtocol.RequestWithResponse<org.jetbrains.wip.protocol.runtime.EvaluateResult, org.jetbrains.wip.protocol.ProtocolReponseReader> {
  /**
  ...
  @Override
  public EvaluateResult readResult(com.google.gson.stream.JsonReaderEx jsonReader, org.jetbrains.wip.protocol.ProtocolReponseReader reader) {
    return reader.readRuntimeEvaluateResult(jsonReader);
  }
}