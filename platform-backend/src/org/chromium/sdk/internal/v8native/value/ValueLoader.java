...
public abstract class ValueLoader implements RemoteValueMapping {
   ...
   */
  public abstract SubpropertiesMirror getOrLoadSubproperties(int ref) throws MethodIsBlockingException;
   ...
   */
  public abstract ValueMirror[] getOrLoadValueFromRefs(List<? extends PropertyReference> propertyRefs) throws MethodIsBlockingException;
